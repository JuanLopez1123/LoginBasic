 ...
 */
public class Prototype_2 extends javax.swing.JDialog {

    /**
     * Creates new form Prototype_2
     */
    conexionMysql con = new conexionMysql();
    Connection cn = con.conectar();
    public static Prototype pr3;
    public Prototype_2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtContra, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 280, 262, -1));

        txtContraseña.setBackground(new java.awt.Color(153, 153, 153));
        jPanel1.add(txtContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 370, 262, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("enter your current password");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 240, 180, -1));
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 460, 210, -1));
        ...
        jButton1.setBackground(new java.awt.Color(170, 238, 158));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Trazado 12.png"))); // NOI18N
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 29, 45));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 400, -1, -1));

        jLabel7.setText("Email");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, 37, -1));

        txtEmail.setBackground(new java.awt.Color(153, 153, 153));
        jPanel1.add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 180, 260, -1));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (!contra.equals("") || !contraseña.equals("") || !usuario.equals("")){
            try {
                PreparedStatement ps = (PreparedStatement) cn.prepareStatement("SELECT `email`, `contraseña` FROM `usuarios` WHERE email = '"+usuario+"' AND contraseña = '"+contra+"'" );
                ResultSetInternalMethods rs = (ResultSetInternalMethods) ps.executeQuery();
                if (rs.next()){
                    
                }else{
                    JOptionPane.showMessageDialog(null, "Incorrect user or old password");
                }
            }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Prototype_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Prototype_2 dialog = new Prototype_2(new javax.swing.JFrame(), true);
